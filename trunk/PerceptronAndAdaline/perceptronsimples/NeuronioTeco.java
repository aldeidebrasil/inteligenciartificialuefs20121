...
public class NeuronioTeco { //Perceptron
	 ...
	 * numero da amostra atual e devolve o valor a ser enviado para a função de ativação. 
	 * 
	...
	/**
	 * Rertona a saída do neuronio após a análise do valor ponderado. 
	 * 
	 ...
	 * 
	 * @param saidaDaFuncao : saida/resposta da função bipoloar
	...
	public void DataRequest(String arquivo) throws FileNotFoundException{
		...
		while(scan.hasNextLine()){
			...
			entradas[line][4] = Float.parseFloat(vetx[4]); //saida desejada é a posição 4 da matriz de cada amostra
			line++;
		}
